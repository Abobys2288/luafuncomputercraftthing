-- CCOS package manifest. Package Manager can use this locally or over HTTP.
return {
    {name="fm", title="File Explorer", desc="Explorer 2.0 with preview, sorting and clipboard", icon="files"},
    {name="edit", title="Text Editor", desc="Edit text files", icon="edit"},
    {name="settings", title="Settings", desc="System, appearance, notifications and crash logs", icon="settings"},
